...
function loadOrders() {
  ...
  if (tableItems !== null) {
    ...
    let newtotalPrice =
      "<tr><th></th><th></th><th style='font-size: small; font-weight: 500 '><b>Total : Rs.<span id='total-price'>0.00</span></b></th></tr>";
    ...
    alert("You Don't have any Order...Please Order the Dish First...");
  }
}
...
function checkout_list(tableOrderName) {
  ...
  let newtotalPrice =
    "<tr><th></th><th></th><th style='font-size: small; font-weight: 500 '><b>Total-Price : Rs.<span id='checkout-total-price'>0.00</span></b></th></tr>";
